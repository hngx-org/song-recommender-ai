                  ...
                  onPressed: () async {
                    ...
                    try {
                      ...
                      if (user != null) {
                        ...
                        logger.d('User Cookies: ${prefs.getString('cookie')}');
                        logger.d(
                            'User Credits: ${prefs.getString('userCredits')}');
                        ...
                        Provider.of<AuthViewModel>(context, listen: false)
                            .setLoading(false);
                        showSnackbar(
                            context, AppColors.userWidgetColor, 'Login ERROR');
                      }
                    } catch (e) {
